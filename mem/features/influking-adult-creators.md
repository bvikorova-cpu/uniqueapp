...
- Revenue split **50/50**: creator gets 3 credits = **€1.50** (at €0.50/credit) — recorded via `public.influencer_earnings` (amount 3.00, platform_fee 1.50, net_amount 1.50, source 'adult_access') , `public.influencer_balances.total_earned += 1.50` and `influencer_profiles.pending_balance/lifetime_earnings += 1.50`, withdrawable through the standard Influ King payout flow (€50 threshold). Remaining €1.50 goes to the platform.
