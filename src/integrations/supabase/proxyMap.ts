...
export const CHECKOUT_PROXY_MAP: Record<string, { product: string; module: string }> = {
  "create-analyzer-credits-payment": { product: "analyzer-credits", module: "analyzer-credits" },
  "create-analyzer-subscription": { product: "analyzer", module: "analyzer" },
  "create-ar-preview-checkout": { product: "ar-preview", module: "ar-preview" },
  ...
  "create-connect-login-link": { product: "connect-login-link", module: "connect-login-link" },
  ...
  "create-digital-offspring": { product: "digital-offspring", module: "digital-offspring" },
  "create-dna-memory-checkout": { product: "dna-memory", module: "dna-memory" },
  "create-emotion-credits-payment": { product: "emotion-credits", module: "emotion-credits" },
  "create-emotion-market-checkout": { product: "emotion-market", module: "emotion-market" },
  "create-employer-subscription-checkout": { product: "employer-subscription", module: "employer-subscription" },
  "create-escape-room-checkout": { product: "escape-room", module: "escape-room" },
  "create-f1-checkout": { product: "f1", module: "f1" },
  "create-fashion-marketplace-payment": { product: "fashion-marketplace", module: "fashion-marketplace" },
  "create-future-face-checkout": { product: "future-face", module: "future-face" },
  "create-healthcare-subscription": { product: "healthcare", module: "healthcare" },
  "create-job-listing-payment": { product: "job-listing", module: "job-listing" },
  "create-kids-reading-checkout": { product: "kids-reading", module: "kids-reading" },
  "create-kids-story-subscription-checkout": { product: "kids-story-subscription", module: "kids-story-subscription" },
  "create-kids-subscription-checkout": { product: "kids-subscription", module: "kids-subscription" },
  "create-learning-payment": { product: "learning", module: "learning" },
  "create-lie-detector-payment": { product: "lie-detector", module: "lie-detector" },
  "create-marketplace-item-checkout": { product: "marketplace-item", module: "marketplace-item" },
  "create-multiverse-checkout": { product: "multiverse", module: "multiverse" },
  "create-pet-checkout": { product: "pet", module: "pet" },
  "create-photo-credits-payment": { product: "photo-credits", module: "photo-credits" },
  "create-property-listing-checkout": { product: "property-listing", module: "property-listing" },
  ...
  "create-teen-career-payment": { product: "teen-career", module: "teen-career" },
  "create-universe": { product: "universe", module: "universe" },
  "create-video-ad-credits-payment": { product: "video-ad-credits", module: "video-ad-credits" },
  "create-vip-checkout": { product: "vip", module: "vip" },
  "create-wellness-checkout": { product: "wellness", module: "wellness" },
  "purchase-best-friend-messages": { product: "best-friend-messages", module: "best-friend-messages" },
  "purchase-content-pack": { product: "content-pack", module: "content-pack" },
  "purchase-premium-course": { product: "premium-course", module: "premium-course" },
  "purchase-psychology-messages": { product: "psychology-messages", module: "psychology-messages" },
  "purchase-shadow-gift": { product: "shadow-gift", module: "shadow-gift" },
  "purchase-stock-content": { product: "stock-content", module: "stock-content" },
