...
export const WallBackground = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      ...
      {/* Softer colorful glow layers with pink and indigo/turquoise */}
      <div className="absolute top-0 left-0 w-[550px] h-[550px] bg-pink-300/20 rounded-full blur-[130px] animate-pulse-slow" />
      <div className="absolute top-1/4 right-0 w-[450px] h-[450px] bg-cyan-300/18 rounded-full blur-[110px] animate-pulse-slow animation-delay-2000" />
      <div className="absolute bottom-0 left-1/4 w-[650px] h-[650px] bg-indigo-200/16 rounded-full blur-[150px] animate-pulse-slow animation-delay-4000" />
      ...
      {/* Enhanced sparkle effects with pink and cyan/indigo tones */}
      ...
      <div className="absolute top-[40%] right-[60%] w-3 h-3 bg-cyan-400 rounded-full animate-sparkle animation-delay-3000 shadow-[0_0_15px_rgba(99,179,237,0.8)]" />
    </div>
  );
};
