...
import { BookOpen, Sparkles, Play, Pause, Volume2, VolumeX } from "lucide-react";
import { Button } from "@/components/ui/button";
import fairytaleHeroVideo from "@/assets/fairytale-hero.mp4.asset.json";

export const FairytaleHero = () => {
  ...
  return (
    <div className="relative h-[46vh] min-h-[280px] sm:h-[56vh] sm:min-h-[360px] w-full overflow-hidden rounded-3xl border border-primary/20 mb-6">
