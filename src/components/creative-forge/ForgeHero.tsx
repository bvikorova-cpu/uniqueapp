...
export function ForgeHero({ credits, creditsLoading }: ForgeHeroProps) {
  ...
  const heroStats = [
    { icon: Users, label: "Active Writers", value: stats.writers || 0, suffix: "+" },
    { icon: FileText, label: "Projects Created", value: stats.projects || 0, suffix: "+" },
    { icon: Star, label: "AI Content", value: stats.content || 0, suffix: "+" },
    { icon: Zap, label: "Generation", value: 0, suffix: "", staticLabel: "~8s" },
  ];
