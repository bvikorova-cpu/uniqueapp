...
const toolDetails: Record<string, { title: string; description: string; features: string[] }> = { "Content Manager": {
  ...
  "Subscribers": { title: "Subscriber Management",
  ...
  "Subscription Tiers": { title: "Subscription Tiers",
  ...
  "Payouts & Earnings": { title: "Payouts & Earnings",
  ...
  "Event Scheduler": { title: "Event Scheduler",
  ...
  "AI Content Assistant": { title: "AI Content Assistant",
  ...
  "Community Polls": { title: "Community Polls & Events",
  ...
  "Live Streams": { title: "Live Streams",
  ...
  "Promotion Tools": { title: "Promotion Tools",
  ...
  "Collaboration Hub": { title: "Collaboration Hub",
  ...
  "Referral System": { title: "Referral System",
  ...
  "Discover Creators": { title: "Discover Creators",
