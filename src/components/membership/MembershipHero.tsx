...
import { Users, TrendingUp, Crown, DollarSign, Play, Pause, Volume2, VolumeX, Sparkles } from "lucide-react";
...
const stats = [
  ...
  { icon: Crown, label: "Subscribers", value: 85000, suffix: "+" },
  { icon: TrendingUp, label: "Avg. Growth", value: 34, suffix: "%" },
  { icon: DollarSign, label: "Creator Earnings", value: 1200000, suffix: "€" },
];
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-card/45 backdrop-blur-md text-foreground text-sm font-semibold border border-border/60">
            ...
            SFW Community-First Creator Platform
