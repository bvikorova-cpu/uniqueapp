...
export function FundraisingHero({ onMyCampaigns, onExplore }: FundraisingHeroProps) {
  ...
  return (
    <div className="relative min-h-[600px] sm:h-[78vh] sm:min-h-[560px] w-full overflow-hidden rounded-3xl border border-amber-500/20 mb-8 shadow-[0_0_80px_-20px_rgba(251,191,36,0.4)]">
      ...
      {/* Content */}
      <div className="relative z-10 min-h-[600px] sm:h-full flex flex-col justify-center pt-14 sm:pt-20 pb-10 px-6 sm:px-10">
