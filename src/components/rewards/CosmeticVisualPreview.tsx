...
const FRAME_STYLE: Record<string, string> = {
  ...
  frame_galactic_mythic: "ring-4 ring-violet-300 shadow-[0_0_34px_rgba(167,139,250,0.95)] bg-[conic-gradient(at_30%_30%,#22d3ee,#a855f7,#f472b6,#facc15,#22d3ee)] animate-[spin_6s_linear_infinite]",
};
...
const NAME_STYLE: Record<string, string> = {
  ...
  name_gold_rush: "bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-700 bg-clip-text text-transparent drop-shadow-[0_1px_2px_rgba(0,0,0,0.25)]",
  name_emerald_glow:
    "text-emerald-500 drop-shadow-[0_0_10px_rgba(52,211,153,0.9)]",
  name_rainbow_flow:
    "bg-gradient-to-r from-pink-500 via-orange-400 to-cyan-500 bg-clip-text text-transparent",
...
const THEME_STYLE: Record<string, string> = {
  ...
  theme_aurora_mythic: "bg-[radial-gradient(circle_at_20%_20%,#34d399,transparent_55%),radial-gradient(circle_at_80%_30%,#818cf8,transparent_55%),linear-gradient(to_bottom_right,#0f172a,#312e81)]",
};
