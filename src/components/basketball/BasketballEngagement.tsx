...
export function BasketballEngagement() {
  const cards = [
    ...
    { icon: BarChart3, title: "Win Rate", value: "0%", desc: "Your match win percentage", gradient: "from-blue-500/20 to-cyan-500/20", iconColor: "text-blue-400" },
