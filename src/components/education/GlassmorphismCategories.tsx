...
const difficultyConfig: Record<Exclude<Difficulty, "all">, { label: string; color: string; bgColor: string; borderColor: string }> = {
  easy: { label: "Ľahké", color: "text-green-600", bgColor: "bg-green-500/10", borderColor: "border-green-500/30" },
  medium: { label: "Stredné", color: "text-yellow-600", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30" },
  hard: { label: "Ťažké", color: "text-orange-600", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30" },
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-xl">
          <Sparkles className="h-5 w-5 text-primary" /> AI-Generované kvízy
        </CardTitle>
        <CardDescription>20 otázok s okamžitou AI spätnou väzbou</CardDescription>
        ...
        <div className="flex flex-wrap gap-2 pt-3">
          ...
          >
            <Filter className="w-3 h-3 mr-1" /> Všetky
          </Button>
      ...
      <CardContent>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[10px] text-muted-foreground">20 otázok</p>
                  </div>
                </div>
        ...
        {filteredCategories.length === 0 && (
          <div className="text-center py-8 text-muted-foreground">
            <p className="text-sm">Žiadne kategórie pre "{searchQuery}"</p>
          </div>
        )}
      </CardContent>
    </Card>
