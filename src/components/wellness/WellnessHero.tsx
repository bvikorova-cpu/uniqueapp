...
import { Heart, Users, Star, Zap, Activity } from "lucide-react";
...
const stats = [
  { icon: Users, label: "Active Users", value: 850, suffix: "+" },
  { icon: Activity, label: "Sessions Today", value: 210, suffix: "+" },
  { icon: Star, label: "Satisfaction", value: 97, suffix: "%" },
  { icon: Zap, label: "Avg. Calm Time", value: 12, suffix: "min" },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-medium">AI-Powered Wellness Platform</span>
      </motion.div>
      ...
      >
        Breathing exercises, mindfulness coaching, gratitude journaling, and sleep tools for your mental wellbeing
      </motion.p>
