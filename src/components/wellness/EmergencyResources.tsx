...
const defaultResources: EmergencyResource[] = [
  {
    ...
    description: '24/7 confidential support for anyone in emotional distress',
    phone: '0800 123 456',
    available: '24/7',
    type: 'crisis',
  },
  {
    ...
    description: 'Text-based support for those who prefer not to call',
    website: 'https://example.com/chat',
    available: '6am - 12am',
    type: 'support',
  },
  {
  ...
  },
  {
    ...
    website: 'https://example.com/groups',
    available: 'Varies',
    type: 'local',
  },
];
