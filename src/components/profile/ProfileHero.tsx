    ...
    <>
      ...
      <div className="relative z-10 px-5 sm:px-8 pt-8 pb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end gap-5 sm:gap-7">
          ...
          <div className="flex-1 min-w-0 text-center sm:text-left">
            ...
            {(profile.occupation || profile.location) && (
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-1 mt-2 text-sm text-amber-50/90" style={{ textShadow: "0 2px 8px rgba(0,0,0,0.8)" }}>
                {profile.occupation && (
            ...
            {/* Actions */}
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:justify-start gap-2 mt-4 w-full [&>*]:w-full [&>*]:h-10 [&>*]:justify-center [&>*]:text-sm sm:[&>*]:w-auto">
              {isOwnProfile ? (
                <Button
                  onClick={onEdit}
        ...
        {(stats.level !== undefined || (stats.rank !== undefined && stats.rank > 0)) && (
          <div className="flex items-center justify-center gap-3 mt-4 text-xs text-amber-100/85 flex-wrap">
