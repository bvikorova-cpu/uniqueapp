...
export const FootballArenaHero = ({ stats }: FootballArenaHeroProps) => {
  const statItems = [
    { icon: Users, label: "Players", value: stats.totalPlayers, accent: "#10b981" },
    { icon: Swords, label: "Matches", value: stats.totalMatches, accent: "#ef4444" },
    { icon: Trophy, label: "Leagues", value: stats.activeLeagues, accent: "#f59e0b" },
    { icon: Wifi, label: "Online", value: stats.onlineManagers, accent: "#06b6d4" },
  ];
