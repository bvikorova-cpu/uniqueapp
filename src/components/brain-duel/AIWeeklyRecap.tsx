...
export const AIWeeklyRecap = () => {
  ...
  return (
    <>
      <FloatingHowItWorks title={"A I Weekly Recap - How it works"} steps={[{ title: 'Open', desc: 'Access the A I Weekly Recap section from its module.' }, { title: 'Explore', desc: 'Review the controls and content available in A I Weekly Recap.' }, { title: 'Interact', desc: 'Use the available actions - browse, select, or submit as needed.' }, { title: 'Review', desc: 'Check the results, updates, or feedback shown after your action.' }]} />
