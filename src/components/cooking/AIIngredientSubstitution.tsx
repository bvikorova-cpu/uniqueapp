...
export default function AIIngredientSubstitution({ onBack }: Props) {
  ...
  return (
    <>
      <FloatingHowItWorks title="How AIIngredient Substitution works" steps={[
