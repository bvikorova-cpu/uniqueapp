...
const HUBS: Hub[] = [
  ...
  { key: "music", label: "Musicians", icon: Music, color: "from-indigo-500 to-blue-500", table: "musician_profiles", path: "/admin/withdrawal-requests" },
  { key: "fund", label: "Fundraising", icon: Heart, color: "from-rose-500 to-pink-500", table: "fundraising_campaigns", path: "/admin/withdrawal-requests" },
  { key: "auc", label: "Auctions", icon: Sparkles, color: "from-amber-500 to-yellow-500", table: "auctions", path: "/admin/withdrawal-requests" },
