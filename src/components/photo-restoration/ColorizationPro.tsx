...
export const ColorizationPro = ({ onBack }: Props) => {
  ...
  return (
    <>
      <FloatingHowItWorks title={"Colorization Pro - How it works"} steps={[{ title: 'Open', desc: 'Access the Colorization Pro section from its module.' }, { title: 'Explore', desc: 'Review the controls and content available in Colorization Pro.' }, { title: 'Interact', desc: 'Use the available actions - browse, select, or submit as needed.' }, { title: 'Review', desc: 'Check the results, updates, or feedback shown after your action.' }]} />
