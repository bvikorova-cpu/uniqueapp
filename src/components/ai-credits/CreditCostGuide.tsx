...
const CATEGORIES: Category[] = [
  {
    ...
    items: [
      ...
      { label: "Future Face (age projection)", cost: "8 cr" },
      { label: "Photo Restoration", cost: "10 cr" },
      { label: "Beauty Studio (skin analysis)", cost: "8 cr" },
      { label: "Fashion — try-on / outfit", cost: "3 cr" },
      { label: "Home / Room Designer", cost: "12 cr" },
      { label: "Brand Builder (full kit)", cost: "30 cr" },
      { label: "Tattoo AI", cost: "5–10 cr" },
  ...
  },
  {
    ...
    items: [
      { label: "Tarot / oracle reading", cost: "8 cr" },
      { label: "Deep reading tools", cost: "5–12 cr" },
      { label: "Astrology — birth chart", cost: "5 cr" },
      { label: "Astrology — compatibility", cost: "8 cr" },
      { label: "Daily horoscope", cost: "Free" },
      { label: "Numerology — life-path", cost: "5 cr" },
      { label: "Numerology — compatibility", cost: "8 cr" },
      { label: "Dream interpretation", cost: "3 cr" },
      { label: "Dream pattern report", cost: "5 cr" },
      { label: "Lottery AI draw", cost: "5 cr" },
      { label: "Crystal energy reading", cost: "5 cr" },
      { label: "Oracle card draw", cost: "2 cr" },
      { label: "Palmistry translation", cost: "3 cr" },
      { label: "Palmistry health report", cost: "8 cr" },
    ],
  },
  {
    id: "dating",
