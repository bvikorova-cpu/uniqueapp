...
export function AudienceAnalyzerView({ onBack }: Props) {
  ...
  return (
    <>
      <FloatingHowItWorks title={"Audience Analyzer View - How it works"} steps={[{ title: 'Open', desc: 'Access the Audience Analyzer View section from its module.' }, { title: 'Explore', desc: 'Review the controls and content available in Audience Analyzer View.' }, { title: 'Interact', desc: 'Use the available actions - browse, select, or submit as needed.' }, { title: 'Review', desc: 'Check the results, updates, or feedback shown after your action.' }]} />
      <div>
