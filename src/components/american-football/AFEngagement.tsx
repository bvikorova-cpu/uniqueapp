...
export function AFEngagement() {
  const cards = [
    ...
    { icon: BarChart3, title: "Win Rate", value: "0%", desc: "Your game win percentage", gradient: "from-green-500/20 to-emerald-500/20", iconColor: "text-green-400" },
  ...
  return (
    <><FloatingHowItWorks title="AFEngagement — How it works" steps={[{title:"Open this section",desc:"Access AFEngagement from the menu."},{title:"Explore features",desc:"Browse cards, filters, matches, tools and options."},{title:"Play & interact",desc:"Start matches, buy items, join tournaments (some actions cost credits or EUR)."},{title:"Track progress",desc:"Check leaderboards, trophies and stats over time."}]} />
