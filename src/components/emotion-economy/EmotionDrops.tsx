  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        ...
        <Card className="border-blue-500/20">
          ...
          <CardContent className="space-y-4">
            ...
            <Button variant="outline" className="w-full" size="lg" onClick={() => console.info("[Coming soon] Notify Me")}>
      ...
      <Card>
        ...
        <CardContent>
          <Button className="w-full" size="lg" onClick={() => console.info("[Coming soon] Create Emotion Drop")}>
