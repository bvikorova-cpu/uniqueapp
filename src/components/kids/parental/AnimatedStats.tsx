...
export const AnimatedStats = ({ stats }: AnimatedStatsProps) => {
  const statItems: StatItem[] = [
    {
      label: "Domáce úlohy",
      value: stats?.homework_tasks || 0,
      prevValue: Math.max((stats?.homework_tasks || 0) - 5, 0),
    ...
    {
      label: "Experimenty",
      value: stats?.science_experiments || 0,
      prevValue: Math.max((stats?.science_experiments || 0) - 3, 0),
    ...
    },
    {
      ...
      prevValue: Math.max((stats?.vocabulary_learned || 0) - 8, 0),
    ...
    {
      label: "Príbehy",
      value: stats?.stories_created || 0,
      prevValue: Math.max((stats?.stories_created || 0) - 2, 0),
    ...
    {
      label: "Kresby",
      value: stats?.drawings_made || 0,
      prevValue: Math.max((stats?.drawings_made || 0) - 1, 0),
    ...
    {
      label: "Celkový čas",
      value: stats?.total_time_minutes || 0,
      prevValue: Math.max((stats?.total_time_minutes || 0) - 30, 0),
