...
export const VariationsView = ({ onCreditsUsed }: Props) => {
  ...
  return (
    <>
      ...
      <div className="ai-mobile-tool-shell ai-variations-mobile-guard w-full max-w-4xl mr-auto space-y-6 pb-96 pr-32 md:mx-auto md:pb-6 md:pr-0">
      <div>
      ...
      <Textarea value={prompt} onChange={(e) => setPrompt(e.target.value)} placeholder="Describe your image concept..." rows={3} className="ai-variations-mobile-input resize-none" />
      
      <Button onClick={generate} disabled={loading || !prompt.trim()} className="ai-mobile-safe-action min-h-12 w-full gap-2 whitespace-normal text-center leading-snug">
