...
export const SimpleAITool = ({ title, emoji, description, cost, action, buttonLabel, buildBody, children, onCreditsUsed,
  ...
  return (
    <>
      ...
      <div className="max-w-2xl mx-auto space-y-6 pb-80 pr-32 md:pb-6 md:pr-0">
      <div>
      ...
      <Button onClick={run} disabled={loading} className="min-h-12 w-full gap-2 whitespace-normal text-center leading-snug">
