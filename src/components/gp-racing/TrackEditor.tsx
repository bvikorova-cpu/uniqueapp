              ...
              <Card className="p-4 bg-slate-900/60 border-cyan-500/20 backdrop-blur-sm hover:border-cyan-400/30 transition-all">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button size="sm" className="bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-500/20 text-cyan-300 font-mono text-[10px]" onClick={() => { window.location.href = `/gp-racing?track=${track.id}&action=race`; }}>
