        ...
        <div className="space-y-4">
          ...
          <Card className="p-6 bg-slate-900/60 border-cyan-500/20 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Button variant="outline" className="border-cyan-500/30 text-cyan-300 hover:bg-cyan-950/30 font-mono text-xs uppercase" onClick={() => console.info("[Coming soon] Team Chat")}>
