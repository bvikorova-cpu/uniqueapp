...
const achievements: Achievement[] = [
  { id: "1", name: "First Blood", description: "Win your first race", icon: Trophy, color: "text-amber-400", bgGradient: "from-amber-950/30 to-orange-950/20", category: "racing", progress: 1, maxProgress: 1, unlocked: true, reward: "1 Credits", rarity: "common" },
  { id: "2", name: "Speed Demon", description: "Win 10 races", icon: Flame, color: "text-orange-400", bgGradient: "from-orange-950/30 to-red-950/20", category: "racing", progress: 7, maxProgress: 10, unlocked: false, reward: "4 Credits + Title", rarity: "rare" },
  { id: "3", name: "Perfect Lap", description: "Set a track record", icon: Target, color: "text-cyan-400", bgGradient: "from-cyan-950/30 to-blue-950/20", category: "racing", progress: 1, maxProgress: 1, unlocked: true, reward: "2 Credits", rarity: "rare" },
  { id: "4", name: "Unbeatable", description: "Win 5 races in a row", icon: Crown, color: "text-violet-400", bgGradient: "from-violet-950/30 to-purple-950/20", category: "racing", progress: 3, maxProgress: 5, unlocked: false, reward: "10 Credits + Crown Badge", rarity: "epic" },
  { id: "5", name: "Car Collector", description: "Own 5 cars", icon: Car, color: "text-emerald-400", bgGradient: "from-emerald-950/30 to-cyan-950/20", category: "garage", progress: 3, maxProgress: 5, unlocked: false, reward: "3 Credits", rarity: "common" },
  { id: "6", name: "Max Power", description: "Upgrade any stat to 100", icon: Zap, color: "text-yellow-400", bgGradient: "from-yellow-950/30 to-amber-950/20", category: "garage", progress: 87, maxProgress: 100, unlocked: false, reward: "6 Credits + Glow Effect", rarity: "rare" },
  { id: "7", name: "Full Garage", description: "Own 10 cars", icon: Shield, color: "text-blue-400", bgGradient: "from-blue-950/30 to-indigo-950/20", category: "garage", progress: 3, maxProgress: 10, unlocked: false, reward: "10 Credits", rarity: "epic" },
  { id: "8", name: "Team Player", description: "Join a racing team", icon: Medal, color: "text-pink-400", bgGradient: "from-pink-950/30 to-rose-950/20", category: "social", progress: 1, maxProgress: 1, unlocked: true, reward: "2 Credits", rarity: "common" },
  { id: "9", name: "Social Racer", description: "Race against 20 unique drivers", icon: Rocket, color: "text-indigo-400", bgGradient: "from-indigo-950/30 to-violet-950/20", category: "social", progress: 12, maxProgress: 20, unlocked: false, reward: "4 Credits", rarity: "rare" },
  { id: "10", name: "Grand Champion", description: "Win a Season Championship", icon: Star, color: "text-amber-300", bgGradient: "from-amber-900/40 to-yellow-900/30", category: "legendary", progress: 0, maxProgress: 1, unlocked: false, reward: "40 Credits + Legendary Title + Exclusive Livery", rarity: "legendary" },
  { id: "11", name: "100 Victories", description: "Win 100 total races", icon: Award, color: "text-red-400", bgGradient: "from-red-950/40 to-orange-950/30", category: "legendary", progress: 7, maxProgress: 100, unlocked: false, reward: "100 Credits + Legend Badge", rarity: "legendary" },
];
