...
const colorMap: Record<string, string> = { blue: "from-blue-500/20 to-blue-600/10 border-blue-500/30 hover:border-blue-400/60",
...
const iconColorMap: Record<string, string> = { blue: "text-blue-500", amber: "text-amber-500", cyan: "text-cyan-500",
