        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {stories.map((story: any) => {
            ...
            return (
              <div
                key={story.id}
                className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-amber-500/10 border border-white/10 p-4 group hover:border-purple-500/30 transition-all"
              >
                {/* Expiry indicator */}
                <div className="absolute top-3 right-3 flex items-center gap-1 text-white/50 text-xs bg-black/30 px-2 py-1 rounded-full">
                ...
                <div className="text-center mb-4">
                  <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center text-5xl transform group-hover:scale-110 transition-transform duration-300">
                    {gift?.gift_emoji}
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-amber-300 font-bold text-lg capitalize">
                ...
                <div className="absolute -top-4 -right-4 w-12 h-12 bg-amber-500/10 rounded-full blur-xl" />
              </div>
            );
          })}
        </div>
