...
import { Share2, Inbox, Gift, Send, ArrowDownLeft, ArrowUpRight } from "lucide-react";
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      {/* Gift emoji */}
                      <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl bg-gradient-to-br from-amber-100 to-yellow-100 flex items-center justify-center text-3xl sm:text-4xl flex-shrink-0 group-hover:scale-110 transition-transform shadow-sm">
                        {gift.gift_emoji}
                      </div>
