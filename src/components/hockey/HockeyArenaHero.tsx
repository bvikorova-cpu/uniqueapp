...
import heroVideo from "@/assets/hockey-arena-hero.mp4.asset.json";
...
export function HockeyArenaHero({ stats }: HockeyArenaHeroProps) {
  const statItems = [
    { icon: Users, label: "Players", value: stats.totalPlayers, accent: "#06b6d4" },
