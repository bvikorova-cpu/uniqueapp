...
export function PrincessAcademy({ onBack }: { onBack: () => void }) {
  ...
  return (
    <>
      <FloatingHowItWorks title={"Princess Academy - How it works"} steps={[{ title: 'Open', desc: 'Access the Princess Academy section from its module.' }, { title: 'Explore', desc: 'Review the controls and content available in Princess Academy.' }, { title: 'Interact', desc: 'Use the available actions - browse, select, or submit as needed.' }, { title: 'Review', desc: 'Check the results, updates, or feedback shown after your action.' }]} />
