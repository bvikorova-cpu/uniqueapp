...
const Navbar = () => {
  ...
  const kidsAcademyServices: { path: string; label: string; icon: LucideIcon; badge?: string }[] = [
    { path: "/kids-channel", label: "Kids Channel", icon: Video },
    { path: "/kids-channel/learning-posters", label: "Learning encyclopedia & posters", icon: BookOpen, badge: "Exclusive" },
  ...
  const otherServiceGroups: { category: string; items: { path: string; label: string; icon: any }[] }[] = [
    {
      category: "Earn Money",
      items: [
        { path: "/earn-money#influ-king", label: "Influ King — Place for Influencers", icon: Star },
        { path: "/earn-money#skills-marketplace", label: "Skills Marketplace — Sell Services", icon: Briefcase },
        { path: "/earn-money#megatalent", label: "Megatalent — Quarterly Prize Pool", icon: Crown },
        { path: "/earn-money#unlock-videos", label: "Unlock Videos — Earn per View", icon: Video },
        { path: "/earn-money#courses", label: "Tutorial & Course Platform — Sell Courses", icon: GraduationCap },
        { path: "/earn-money#referrals", label: "Referrals — Invite & Earn", icon: UserPlus },
        { path: "/earn-money#gifts", label: "Gifts — Receive Paid Gifts", icon: Gift },
        { path: "/earn-money#challenges", label: "Challenges — Compete for Monthly Prizes", icon: Leaf },
        { path: "/earn-money#property-marketplace", label: "Property Marketplace", icon: Building2 },
        { path: "/earn-money#bazaar", label: "Bazaar — Sell Your Items", icon: Store },
        { path: "/earn-money#coupon-marketplace", label: "Coupon Marketplace", icon: Ticket },
        { path: "/earn-money#stock-content", label: "Stock Content Library", icon: ImageIcon },
        { path: "/earn-money#online-auctions", label: "Online Auctions", icon: Gavel },
        { path: "/earn-money#antique-appraisal", label: "Antique Appraisal", icon: Gem },
        { path: "/earn-money#live-concerts", label: "Live Concerts — Tickets & Gifts", icon: Music },
        { path: "/earn-money#stand-up-comedy", label: "Stand-up Comedy — Tickets & Tips", icon: Mic2 },
      ],
    },
    {
