  ...
  const analyze = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke("generate-gift-message", {
        ...
        body: {
          prompt: `Post-match analysis for tennis team "${team?.name || "My Team"}" (W${team?.wins || 0} L${team?.losses || 0}). Provide:\n1. Performance summary\n2. Serve efficiency & ace rate\n3. Return game analysis\n4. Net approach success rate\n5. Break point conversion\n6. Player development recommendations`,
          type: "tennis_analysis"
        }
      });
