...
import heroVideo from "@/assets/tennis-arena-hero.mp4.asset.json";
...
export function TennisArenaHero({ stats }: TennisArenaHeroProps) {
  const statItems = [
    { icon: Users, label: "Players", value: stats.totalPlayers, accent: "#84cc16" },
  ...
  return (
    <>
      <FloatingHowItWorks title={"Tennis Arena Hero - How it works"} steps={[{ title: 'Open', desc: 'Access the Tennis Arena Hero section from its module.' }, { title: 'Explore', desc: 'Review the controls and content available in Tennis Arena Hero.' }, { title: 'Interact', desc: 'Use the available actions - browse, select, or submit as needed.' }, { title: 'Review', desc: 'Check the results, updates, or feedback shown after your action.' }]} />
