...
export function TennisToolCard({ icon: Icon, title, description, badge, credits, gradient, iconColor, onClick, delay }: TennisToolCardProps) {
  return (
    <><FloatingHowItWorks title="TennisToolCard — How it works" steps={[{title:"Open this section",desc:"Access TennisToolCard from the menu."},{title:"Explore features",desc:"Browse cards, filters, matches, tools and options."},{title:"Play & interact",desc:"Start matches, buy items, join tournaments (some actions cost credits or EUR)."},{title:"Track progress",desc:"Check leaderboards, trophies and stats over time."}]} />
