...
const stats = [
  ...
  { icon: Sparkles, label: "Energy Readings", value: 48000, suffix: "+" },
  { icon: Heart, label: "Crystals Analyzed", value: 25000, suffix: "+" },
  { icon: TrendingUp, label: "Healing Sessions", value: 8700, suffix: "+" },
];
