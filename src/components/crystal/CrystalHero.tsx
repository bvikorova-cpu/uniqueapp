...
const AnimatedCounter = ({ target, suffix = "" }: { target: number; suffix?: string }) => {
  ...
  useEffect(() => {
    ...
    return (
    <>
      <FloatingHowItWorks title={"Crystal Hero - How it works"} steps={[{ title: 'Open', desc: 'Access the Crystal Hero section from its module.' }, { title: 'Explore', desc: 'Review the controls and content available in Crystal Hero.' }, { title: 'Interact', desc: 'Use the available actions - browse, select, or submit as needed.' }, { title: 'Review', desc: 'Check the results, updates, or feedback shown after your action.' }]} />
