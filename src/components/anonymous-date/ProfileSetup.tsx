...
// Stats hidden until real metrics are wired (matches/messages/reveals).
// Re-enable by populating with live data from anonymous_dating_* tables.
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      >
        ...
        {/* Stats row hidden — see comment near top of file */}
      </motion.div>
