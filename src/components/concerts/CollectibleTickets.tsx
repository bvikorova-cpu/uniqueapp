              ...
              <CardContent className="p-4 space-y-3">
                ...
                {owned.has(ticket.id) ? (
                  <div className="flex gap-2">
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => console.info("[Coming soon] Share")}><Share2 className="w-3 h-3 mr-1" /> Share</Button>
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => console.info("[Coming soon] Save")}><Download className="w-3 h-3 mr-1" /> Save</Button>
                  </div>
                ) : (
