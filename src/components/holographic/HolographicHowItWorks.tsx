...
export const HolographicHowItWorks = ({ onBack }: Props) => {
  const steps = [
    ...
    { icon: Palette, title: "3. Customize & Upgrade", desc: "Unlock hundreds of appearance options, clothing, accessories, custom animations, and voice packs through our customization packs (Basic 5 credits or Advanced 15 credits)." },
    { icon: Swords, title: "4. Battle Other Avatars", desc: "Enter the Battle Arena for PvP combat. Choose 1v1 Duels (2 credits), Tournaments (5 credits), or Survival mode (3 credits). Win prizes and climb the ELO ranking leaderboard." },
    { icon: Heart, title: "5. Breed Unique Offspring", desc: "Combine two avatars to create offspring with inherited traits and abilities. Rare trait combinations can produce Legendary avatars. Each pair can breed up to 3 offspring (10 credits)." },
