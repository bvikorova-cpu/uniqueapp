...
const HORSE_EXPECTED: Record<string, string> = { "horse-create": "create",
  "horse-train": "train",
...
const VIDEO_AD_EXPECTED: Record<string, string> = { "video-ad-scenes": "scenes",
  "video-ad-sfx": "sfx",
  "video-ad-tts": "tts",
...
describe("proxyMap router consolidation", () => {
  ...
  describe("B18c events consolidation", () => { const EVENTS_EXPECTED: Record<string, string> = {
  ...
  describe("B18d creator economy consolidation", () => { const CREATOR_EXPECTED: Record<string, string> = {
  ...
  describe("B18f other consolidation", () => { const OTHER_EXPECTED: Record<string, string> = {
