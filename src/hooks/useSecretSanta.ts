...
export const GIFT_CATALOG = [
  ...
  // Disney characters (10-500 credits)
  { type: "elsa", emoji: "❄️", label: "Elsa", value: 45, category: "disney", description: "Ice Queen magic" },
  { type: "anna", emoji: "🧡", label: "Anna", value: 40, category: "disney", description: "Brave princess" },
  { type: "olaf", emoji: "⛄", label: "Olaf", value: 25, category: "disney", description: "Warm hugs" },
  { type: "moana", emoji: "🌊", label: "Moana", value: 50, category: "disney", description: "Ocean voyager" },
  { type: "simba", emoji: "🦁", label: "Simba", value: 55, category: "disney", description: "Lion King" },
  { type: "nemo", emoji: "🐠", label: "Nemo", value: 30, category: "disney", description: "Little fish" },
  { type: "dory", emoji: "🐟", label: "Dory", value: 35, category: "disney", description: "Just keep swimming" },
  { type: "woody", emoji: "🤠", label: "Woody", value: 45, category: "disney", description: "Cowboy friend" },
  { type: "buzz", emoji: "🚀", label: "Buzz Lightyear", value: 50, category: "disney", description: "To infinity!" },
  { type: "mickey", emoji: "🐭", label: "Mickey Mouse", value: 60, category: "disney", description: "Disney icon" },
  ...
  { type: "ariel", emoji: "🧜‍♀️", label: "Ariel", value: 65, category: "disney", description: "Little Mermaid" },
  { type: "belle", emoji: "📖", label: "Belle", value: 60, category: "disney", description: "Beauty & wisdom" },
  { type: "cinderella", emoji: "👠", label: "Cinderella", value: 55, category: "disney", description: "Glass slipper" },
  { type: "rapunzel", emoji: "💇‍♀️", label: "Rapunzel", value: 50, category: "disney", description: "Golden hair" },
  { type: "jasmine", emoji: "🧞", label: "Jasmine", value: 55, category: "disney", description: "Arabian princess" },
  { type: "mulan", emoji: "⚔️", label: "Mulan", value: 60, category: "disney", description: "Warrior princess" },
  { type: "tiana", emoji: "🐸", label: "Tiana", value: 50, category: "disney", description: "Princess & frog" },
  { type: "merida", emoji: "🏹", label: "Merida", value: 55, category: "disney", description: "Brave archer" },
  { type: "pocahontas", emoji: "🍂", label: "Pocahontas", value: 50, category: "disney", description: "Colors of wind" },
  { type: "aladdin", emoji: "🪔", label: "Aladdin", value: 45, category: "disney", description: "Street rat hero" },
  { type: "genie", emoji: "🧞‍♂️", label: "Genie", value: 80, category: "disney", description: "3 wishes granted" },
  ...
  { type: "tinkerbell", emoji: "🧚", label: "Tinker Bell", value: 45, category: "disney", description: "Pixie dust" },
