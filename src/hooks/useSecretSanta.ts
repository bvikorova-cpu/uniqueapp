...
export const GIFT_CATALOG = [
  ...
  // Fantasy characters (25-90 credits) - original, IP-safe designs
  { type: "ice_queen", emoji: "❄️", label: "Ice Queen", value: 45, category: "fantasy", description: "Frostborn sovereign" },
  { type: "snow_sister", emoji: "🧡", label: "Snow Sister", value: 40, category: "fantasy", description: "Warm-hearted heir" },
  { type: "snow_pal", emoji: "⛄", label: "Snow Pal", value: 25, category: "fantasy", description: "Made of warm hugs" },
  { type: "wave_voyager", emoji: "🌊", label: "Wave Voyager", value: 50, category: "fantasy", description: "Ocean wayfinder" },
  { type: "sun_lion", emoji: "🦁", label: "Sun Lion", value: 55, category: "fantasy", description: "Pride of the savanna" },
  { type: "reef_fry", emoji: "🐠", label: "Reef Fry", value: 30, category: "fantasy", description: "Tiny brave swimmer" },
  { type: "blue_finn", emoji: "🐟", label: "Blue Finn", value: 35, category: "fantasy", description: "Never stops swimming" },
  { type: "cowboy_toy", emoji: "🤠", label: "Cowboy Toy", value: 45, category: "fantasy", description: "Loyal playroom friend" },
  { type: "space_ranger", emoji: "🚀", label: "Space Ranger", value: 50, category: "fantasy", description: "Beyond the stars" },
  { type: "mouse_mascot", emoji: "🐭", label: "Mouse Mascot", value: 60, category: "fantasy", description: "Cheerful cartoon icon" },
  { type: "ribbon_mouse", emoji: "🎀", label: "Ribbon Mouse", value: 55, category: "fantasy", description: "Polka-dot charm" },
  { type: "duck_pal", emoji: "🦆", label: "Duck Pal", value: 40, category: "fantasy", description: "Feathered friend" },
  { type: "tall_hound", emoji: "🐕", label: "Tall Hound", value: 35, category: "fantasy", description: "Goofy sidekick" },
  { type: "star_pup", emoji: "🐶", label: "Star Pup", value: 30, category: "fantasy", description: "Loyal companion" },
  { type: "sea_maiden", emoji: "🧜‍♀️", label: "Sea Maiden", value: 65, category: "fantasy", description: "Song of the tides" },
  { type: "book_lover", emoji: "📖", label: "Book Lover", value: 60, category: "fantasy", description: "Beauty and wisdom" },
  { type: "glass_slipper_girl", emoji: "👠", label: "Glass Slipper Girl", value: 55, category: "fantasy", description: "Midnight magic" },
  { type: "golden_braid", emoji: "💇‍♀️", label: "Golden Braid", value: 50, category: "fantasy", description: "Tower of light" },
  { type: "desert_princess", emoji: "🧞", label: "Desert Princess", value: 55, category: "fantasy", description: "Sands and stars" },
  { type: "warrior_maiden", emoji: "⚔️", label: "Warrior Maiden", value: 60, category: "fantasy", description: "Courage in armor" },
  { type: "marsh_princess", emoji: "🐸", label: "Marsh Princess", value: 50, category: "fantasy", description: "Bayou dreamer" },
  { type: "highland_archer", emoji: "🏹", label: "Highland Archer", value: 55, category: "fantasy", description: "Arrow of fate" },
  { type: "forest_walker", emoji: "🍂", label: "Forest Walker", value: 50, category: "fantasy", description: "Colors of the wind" },
  { type: "street_hero", emoji: "🪔", label: "Street Hero", value: 45, category: "fantasy", description: "Lamp of luck" },
  { type: "wish_spirit", emoji: "🧞‍♂️", label: "Wish Spirit", value: 80, category: "fantasy", description: "Three wishes granted" },
  { type: "star_critter", emoji: "👽", label: "Star Critter", value: 70, category: "fantasy", description: "Family means everything" },
  { type: "sky_elephant", emoji: "🐘", label: "Sky Elephant", value: 40, category: "fantasy", description: "Flies on big ears" },
  { type: "meadow_fawn", emoji: "🦌", label: "Meadow Fawn", value: 35, category: "fantasy", description: "Prince of the forest" },
  { type: "pixie_spark", emoji: "🧚", label: "Pixie Spark", value: 45, category: "fantasy", description: "Trail of glitter" },
  { type: "neverland_boy", emoji: "🪶", label: "Neverland Boy", value: 50, category: "fantasy", description: "Forever young" },
  { type: "curious_girl", emoji: "🐇", label: "Curious Girl", value: 45, category: "fantasy", description: "Down the rabbit hole" },
  { type: "apple_maiden", emoji: "🍎", label: "Apple Maiden", value: 50, category: "fantasy", description: "Fairest heart" },
  { type: "rose_princess", emoji: "🌹", label: "Rose Princess", value: 55, category: "fantasy", description: "Dream of thorns" },
  { type: "wooden_boy", emoji: "🪵", label: "Wooden Boy", value: 35, category: "fantasy", description: "Wishing to be real" },
  { type: "bear_uncle", emoji: "🐻", label: "Bear Uncle", value: 40, category: "fantasy", description: "Bare necessities" },
  { type: "jungle_child", emoji: "🌴", label: "Jungle Child", value: 35, category: "fantasy", description: "Raised by wolves" },
  { type: "vine_swinger", emoji: "🦍", label: "Vine Swinger", value: 45, category: "fantasy", description: "King of the canopy" },
  { type: "demigod_hero", emoji: "🏛️", label: "Demigod Hero", value: 65, category: "fantasy", description: "Zero to hero" },
  { type: "island_trickster", emoji: "🪝", label: "Island Trickster", value: 70, category: "fantasy", description: "Hook of legend" },
  { type: "underworld_lord", emoji: "🔥", label: "Underworld Lord", value: 75, category: "fantasy", description: "Ruler of shades" },
  { type: "thorn_sorceress", emoji: "🐉", label: "Thorn Sorceress", value: 80, category: "fantasy", description: "Mistress of curses" },
  { type: "sea_witch", emoji: "🐙", label: "Sea Witch", value: 70, category: "fantasy", description: "Deals in the deep" },
  { type: "shadow_lion", emoji: "🦁", label: "Shadow Lion", value: 65, category: "fantasy", description: "Be prepared" },
  { type: "chef_rat", emoji: "🐀", label: "Chef Rat", value: 45, category: "fantasy", description: "Tiny gourmet genius" },
  { type: "tidy_bot", emoji: "🤖", label: "Tidy Bot", value: 55, category: "fantasy", description: "Little love machine" },
  { type: "scout_bot", emoji: "🌱", label: "Scout Bot", value: 50, category: "fantasy", description: "Finder of life" },
  { type: "fuzzy_giant", emoji: "👹", label: "Fuzzy Giant", value: 55, category: "fantasy", description: "Big blue softie" },
  { type: "one_eye_buddy", emoji: "👁️", label: "One-Eye Buddy", value: 45, category: "fantasy", description: "Comedy sidekick" },
  { type: "strong_dad", emoji: "🦸", label: "Strong Dad", value: 60, category: "fantasy", description: "Unbreakable strength" },
  { type: "stretch_mom", emoji: "🦸‍♀️", label: "Stretch Mom", value: 60, category: "fantasy", description: "Flexible hero" },
  { type: "frost_hero", emoji: "🧊", label: "Frost Hero", value: 55, category: "fantasy", description: "Ice cool ally" },
