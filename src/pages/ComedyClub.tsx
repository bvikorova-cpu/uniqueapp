...
const tools = [
  ...
  { id: "browse" as ViewType, icon: Ticket, title: "Browse Shows", description: "Discover & buy tickets (EUR) for upcoming stand-up shows", color: "red" },
];
  ...
  return (
    <>
      <FloatingHowItWorks title="How Comedy Club works" steps={[
        ...
        { title: 'Interact', desc: 'Buy tickets in euros or host your own show.' },
              ...
              <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-background">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {[
                      { icon: Ticket, title: "For Fans", desc: "Browse upcoming shows, buy tickets by card in euros, and watch live streams." },
