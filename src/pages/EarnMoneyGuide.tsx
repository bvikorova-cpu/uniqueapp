...
const earnGuides: EarnGuide[] = [
  {
    ...
    icon: Star,
    income: [
      "Fan subscriptions with creator-set membership levels",
      "Pay-per-view (PPV) posts — followers pay once to open your locked post",
      "Paid photo or video messages in Messenger — a fan pays to unlock your media",
      "Wishlist — fans fund real items straight from your profile with their card",
      "Tips and paid gifts from supporters, plus a Top Fans leaderboard of your biggest spenders",
      "Brand collaboration opportunities",
    ],
    whereToEarn: "Register as a creator in Influ King — everything happens from that creator profile. Attach a price to a post to make it PPV; use the paid photo/video button in Messenger to send a paid message; add items to your public Wishlist; your Top Fans section ranks the fans who support you the most.",
    payout: "Subscriptions, PPV posts and paid messages split 85% to you / 15% platform fee. Tips keep 90% for you / 10% platform. Wishlist items are funded by fans with their card and the same 85/15 share applies. Everything lands in your Influ King earnings — open Track & Withdraw Earnings to see the balance (currently a €50 minimum withdrawal) and request a payout.",
    steps: [
      "Create a credible creator profile with a clear niche.",
      "Publish consistently and give followers a reason to return.",
      "Attach prices where it makes sense: PPV posts, paid messages, membership levels.",
      "Add wishlist items so fans can fund something concrete.",
      "Track performance and available payouts in your creator tools.",
    ],
  ...
  },
  {
    ...
    icon: Video,
    income: [
      "Creator earnings for completed premium unlocks",
      "Distribution in three places at once: the Unlock Videos feed, the Wall Videos feed and Wall posts you share it to",
      "Viewers always hit the paywall at exactly the halfway point of the video",
      "Earned value tracked separately from purchased unlock credits",
    ],
    whereToEarn: "Open Unlock Videos, go to My Videos and upload a premium video. It plays everywhere the same way: the first half is free in Unlock Videos, in Wall Videos and when someone opens it from your Wall post — then playback pauses at the exact halfway point and viewers spend one unlock credit to watch the rest.",
    ...
    steps: [
      "Upload an original video that follows platform rules.",
      "Put your best material after the halfway point — that is where the paywall lands.",
      "Publish and share it so it appears in Unlock Videos, Wall Videos and your Wall posts.",
      "View unlock activity and earnings in your account.",
    ],
  ...
  },
  {
    id: "referrals",
    title: "Referrals",
    kicker: "Get paid every month a friend stays",
    hook: "One good invitation can pay you again and again. When a friend you invited keeps their subscription, €5 lands in your balance on every paid invoice — not just once.",
    ...
    icon: UserPlus,
    income: [
      "€5 for every month an invited friend keeps paying — recurring, credited on each paid invoice",
      "Works with both plans: Premium (€10/month) and TOP Premium (€15/month)",
      "Milestones and leaderboard progress",
      "Withdrawal tools for completed referral earnings",
    ],
    whereToEarn: "Open Referrals, copy your personal link or code and share it. Your friend registers through that link, activates Megatalent Premium or TOP Premium, and once their payment is confirmed the attribution is approved — from then on every invoice they pay credits €5 to you automatically.",
    payout: "The reward is €5 per paid invoice of an invited friend and it repeats while the subscription stays active — a friend on Premium for 6 months means €30 for you. Earnings appear on the Referral page; the minimum withdrawal shown there is €10. Registration alone does not create the reward: the friend must complete a real paid subscription and it cannot be your own account.",
    steps: [
      "Open your referral page and copy your personal link or code.",
      "Send it privately to people who would benefit from Unique.",
      "Let them register through the link and activate Premium or TOP Premium.",
      "Track verified referrals and available rewards on the page.",
    ],
    momentum: ["Explain which Unique section fits each person.", "Share directly instead of posting spam.", "Remind friends about what their plan includes so they stay active."],
  ...
  },
  {
    ...
    icon: Gift,
    income: [
      "Paid gifts under your Wall posts — the Gift button below any post you publish",
      "Paid gifts inside Messenger — the gift-box button in a conversation with you",
      "Six gift tiers: Heart 10, Star 25, Fire 50, Trophy 100, Crown 250 and Diamond 500 credits",
      "A visible history of received gifts",
    ],
    whereToEarn: "People can send you a gift in two exact places: from the Gift button under your Wall post, or from the gift-box button inside a Messenger conversation with you. The gift is credited automatically to the author of the post or the recipient of the message — no separate creator switch needed.",
    payout: "You receive 50% of the gift’s purchased-credit value in euros. Because 1 credit equals €0.50, your share is €0.25 per gifted credit — a Diamond (500 credits) means €125 to you. Only gifts paid with purchased credits create cash earnings; free or bonus-credit gifts do not. Open My gifts → Received to see earnings and request withdrawal from €20.",
    steps: [
      "Publish an original Wall post people value, or build genuine conversations in Messenger.",
      "A supporter taps Gift below your post or the gift-box icon in your chat, chooses a gift and confirms its credit price.",
      "Unique records the gift automatically in your My gifts inbox.",
      "Open Profile → My gifts → Received, check the euro balance and use Withdraw after the available amount reaches €20.",
    ],
  ...
  },
  {
    ...
    payout: "Publishing is free — you just watch one short sponsored ad — and the buyer’s first message also unlocks after one short ad. Unique takes no sale commission and does not hold Bazaar proceeds; the buyer pays you directly under your agreement.",
  ...
  },
  {
    ...
    payout: "Publishing is free — you just watch one short sponsored ad — and the buyer’s first message also unlocks after one short ad. Unique takes no commission; payment is settled directly between buyer and seller. Only transfer a code after the agreed payment is confirmed.",
  ...
  },
  {
    ...
    payout: "Publishing an auction is free — you just watch one short sponsored ad; bidding is free and the first seller contact unlocks after one short ad. The current auction flow states no sale commission and direct settlement with the seller—there is no automatic payout merely because an auction receives a bid.",
