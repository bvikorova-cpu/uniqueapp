...
import { Heart, Play, Star, Sparkles, Crown, BookOpen, Volume2, Trophy, Moon, CreditCard, Video, Castle, Palette, Skull, Globe, Theater, Tent, ChefHat, Cake, Car, Truck } from "lucide-react";
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          {/* 10. Dinosaur Quiz & Encyclopedia */}
          <Card 
            className="group overflow-hidden bg-gradient-to-br from-green-100/95 to-lime-100/95 backdrop-blur-sm border-4 border-white/60 hover:border-green-400 transition-all duration-300 hover:scale-105 cursor-pointer shadow-2xl hover:shadow-green-300/50 animate-fade-in"
            style={{ animationDelay: "0.9s" }}
            onClick={() => navigate('/kids-channel/dinosaur-quiz')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
                <Skull className="w-10 h-10 text-green-600" />
              </div>
              <h3 className="text-xl font-bold text-green-700 mb-2">
                Dinosaur Quiz! 🦕
              </h3>
              <p className="text-gray-700 text-sm mb-3">
                Interactive quiz about dinosaurs with 3D models and fun facts!
              </p>
              <Badge className="bg-green-500 text-white shadow-md">Educational</Badge>
            </div>
          </Card>

          {/* 11. Virtual Travel Map */}
          <Card 
            className="group overflow-hidden bg-gradient-to-br from-teal-100/95 to-cyan-100/95 backdrop-blur-sm border-4 border-white/60 hover:border-teal-400 transition-all duration-300 hover:scale-105 cursor-pointer shadow-2xl hover:shadow-teal-300/50 animate-fade-in"
            style={{ animationDelay: "1s" }}
            onClick={() => navigate('/kids-channel/travel-map')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
              ...
              <p className="text-gray-700 text-sm mb-3">
                Collect passport stamps, learn about countries with mini games!
              </p>
              <Badge className="bg-teal-500 text-white shadow-md">Adventure</Badge>
            </div>
          </Card>

          {/* 12. Puppet Theater Maker */}
          <Card 
            className="group overflow-hidden bg-gradient-to-br from-rose-100/95 to-red-100/95 backdrop-blur-sm border-4 border-white/60 hover:border-rose-400 transition-all duration-300 hover:scale-105 cursor-pointer shadow-2xl hover:shadow-rose-300/50 animate-fade-in"
            style={{ animationDelay: "1.1s" }}
            onClick={() => navigate('/kids-channel/puppet-theater')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
                <Theater className="w-10 h-10 text-rose-600" />
              </div>
              <h3 className="text-xl font-bold text-rose-700 mb-2">
                Puppet Theater! 🎭
              </h3>
              <p className="text-gray-700 text-sm mb-3">
                Create puppets, record voices, animate stories and share!
              </p>
              <Badge className="bg-rose-500 text-white shadow-md">Creative</Badge>
            </div>
          </Card>
          ...
          <Card 
            ...
            onClick={() => navigate('/kids-channel/circus-academy')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
                <Tent className="w-10 h-10 text-yellow-600" />
              </div>
              <h3 className="text-xl font-bold text-yellow-700 mb-2">
                Circus Academy! 🎪
              </h3>
              <p className="text-gray-700 text-sm mb-3">
                Learn virtual tricks, play skill games, collect stars!
              </p>
              <Badge className="bg-yellow-500 text-white shadow-md">Games</Badge>
            </div>
          </Card>

          {/* 14. MasterChef Junior Arena */}
          <Card 
            className="group overflow-hidden bg-gradient-to-br from-red-100/95 to-orange-100/95 backdrop-blur-sm border-4 border-white/60 hover:border-red-400 transition-all duration-300 hover:scale-105 cursor-pointer shadow-2xl hover:shadow-red-300/50 animate-fade-in"
            style={{ animationDelay: "1.3s" }}
            onClick={() => navigate('/kids-channel/masterchef-junior')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
              ...
              <p className="text-gray-700 text-sm mb-3">
                Cook against time, compete with others in real-time challenges!
              </p>
              <Badge className="bg-red-500 text-white shadow-md">Competition</Badge>
            </div>
          </Card>

          {/* 15. Cake Decorating Championship */}
          <Card 
            className="group overflow-hidden bg-gradient-to-br from-pink-100/95 to-fuchsia-100/95 backdrop-blur-sm border-4 border-white/60 hover:border-pink-400 transition-all duration-300 hover:scale-105 cursor-pointer shadow-2xl hover:shadow-pink-300/50 animate-fade-in"
            style={{ animationDelay: "1.4s" }}
            onClick={() => navigate('/kids-channel/cake-decorating')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
              ...
              <p className="text-gray-700 text-sm mb-3">
                Decorate cakes on time with tools, themes and audience voting!
              </p>
              <Badge className="bg-pink-500 text-white shadow-md">Creative</Badge>
            </div>
          </Card>

          {/* 16. Formula 1 Grand Prix */}
          <Card 
            className="group overflow-hidden bg-gradient-to-br from-red-100/95 to-gray-100/95 backdrop-blur-sm border-4 border-white/60 hover:border-red-400 transition-all duration-300 hover:scale-105 cursor-pointer shadow-2xl hover:shadow-red-300/50 animate-fade-in"
            style={{ animationDelay: "1.5s" }}
            onClick={() => navigate('/kids-channel/formula1')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
              ...
              <p className="text-gray-700 text-sm mb-3">
                Real-time races, pit stops, weather effects and leagues!
              </p>
              <Badge className="bg-red-500 text-white shadow-md">Racing</Badge>
            </div>
          </Card>

          {/* 17. Monster Truck Mayhem */}
          <Card 
            className="group overflow-hidden bg-gradient-to-br from-indigo-100/95 to-purple-100/95 backdrop-blur-sm border-4 border-white/60 hover:border-indigo-400 transition-all duration-300 hover:scale-105 cursor-pointer shadow-2xl hover:shadow-indigo-300/50 animate-fade-in"
            style={{ animationDelay: "1.6s" }}
            onClick={() => navigate('/kids-channel/monster-trucks')}
          >
            <div className="p-6 text-center">
              <div className="bg-white rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
              ...
              <p className="text-gray-700 text-sm mb-3">
                Jump obstacles, collect crash points, custom truck design!
              </p>
              <Badge className="bg-indigo-500 text-white shadow-md">Action</Badge>
            </div>
          </Card>
        </div>
      </div>
