...
const ALL_CATEGORIES: Category[] = [
    ...
    ] },
  {
    ...
    sections: [
      ...
      { path: "/lucky-wheel", title: "Lucky Wheel", icon: Gift, blurb: "Daily spin for credits, XP and surprise rewards.", features: ["Daily free spin", "Credit prizes", "XP boosts", "Streak bonuses", "Rare rewards", "Spin history"], details: "Spin the Lucky Wheel once a day for credits, XP, badges and rare surprise rewards. Streaks increase prize quality; every spin is recorded in your history.", pricing: "1 free spin per day • Extra spins in credits", capabilities: ["Daily free spin", "Credit & XP prizes", "Streak-based odds", "Rare reward tier", "Spin history", "Fair drop transparency"] },
  ...
  { id: "membership",
    ...
    sections: [
      { path: "/rewards", title: "Rewards & Daily Login", icon: Gift, blurb: "Daily login calendar, streaks, challenges and claimable credit rewards.", features: ["Daily login calendar", "Streak bonuses", "Challenges", "XP levels", "Claimable credits", "Reward history"], details: "Check in daily to build a streak and claim rewards — credits, XP and badges. Challenges add extra goals each week and everything you claim is recorded in your reward history.", pricing: "Free • Rewards paid out in credits and XP", capabilities: ["Daily login calendar", "Streak tracking", "Weekly challenges", "XP levels", "Claimable credit rewards", "Reward history"] },
      {
