...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { path: "/karaoke", title: "Karaoke Live", icon: Mic2, blurb: "Sing live, get votes, win crowd rewards.", features: ["Live rooms", "Voting", "Rewards", "Song library"], details: "Karaoke rooms where singers perform live and audiences vote. Winners collect crowd tips. Song library curated from public catalog.", pricing: "Free to join • Tips optional • Platform 20% on tips", capabilities: ["Live singing rooms", "Audience voting", "Crowd tips", "Song library", "Leaderboards", "Recording of performances"] },
