  ...
  { id: "social",
    ...
    sections: [
      ...
      { path: "/messenger", title: "Messenger", icon: Mail,
        blurb: "1:1 and group chats with media, reactions and voice notes.",
        features: ["Privacy-first messaging", "Voice notes", "Group chats up to 100", "Pinned messages", "Media gallery", "Disappearing messages"],
        details: "A unified messenger that replaces every legacy DM layer in the platform. Chat 1:1, in small groups or in topic rooms with full media support, reactions, replies, voice notes and read receipts. Conversations are partitioned by community so DMs from creators, friends and brands never collide.",
        pricing: "Free • Premium creator DMs may be paid (PPV unlocked by creator)",
        capabilities: ["End-to-end style encryption", "Voice notes & media messages", "File attachments (images, PDF, audio)", "Typing indicators & read receipts", "Block, mute, report and archive", "Search across conversations", "Auto-delete timers"] },
    ...
    ] },
  {
    ...
    sections: [
      { path: "/influ-king", title: "Influ-King", icon: Star,
        blurb: "All-in-one creator hub: AI content tools, brand deals, analytics, PPV posts and live streams.",
        features: ["AI content planner", "Brand deal finder", "Collab matchmaker", "Audience analytics", "PPV studio", "Live streaming"],
        details: "Influ-King is the central dashboard for creators and influencers. Plan content with AI, find brand deals, match with collaborators, analyze audience growth, publish pay-per-view posts and go live to followers. Every tool is credit-based so creators only pay for what they use.",
        pricing: "Free profile • AI tools 3-10 credits • PPV unlocks set by creator • Live stream free",
        capabilities: ["AI content planner & calendar", "Brand deal discovery & applications", "Collaboration matchmaking", "Follower & engagement analytics", "Hashtag & thumbnail generators", "PPV post studio", "Live stream with gifts & tips", "Creator earnings dashboard"] },
