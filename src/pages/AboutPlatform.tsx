...
const ALL_CATEGORIES: Category[] = [
    ...
    ] },
  {
    ...
    sections: [
      ...
      { path: "/sports-predictor", title: "Sports Predictor", icon: Trophy, blurb: "AI-assisted match predictions, tipsters and prediction leaderboards.", features: ["Match predictions", "AI analysis", "Tipster profiles", "Accuracy tracking", "Leaderboards", "Paid tips"], details: "Follow upcoming matches, read AI-assisted analysis and make your own predictions. Tipsters publish free and paid tips; every prediction is scored so accuracy is public and verifiable. Entertainment only — no betting on the platform.", pricing: "AI analysis 3 credits • Paid tips priced by tipster (85/15 split)", capabilities: ["Upcoming match list", "AI match analysis", "Personal prediction log", "Accuracy statistics", "Tipster marketplace", "Prediction leaderboard", "Result notifications"] },
    ...
    ] },
  {
    ...
    sections: [
      ...
      { path: "/music", title: "Music", icon: Music, blurb: "Stream tracks from platform artists and support them directly.", features: ["Artist tracks", "Playlists", "Streaming royalties", "Tips", "Artist profiles", "Charts"], details: "Listen to music uploaded by verified platform artists, build playlists and support artists directly. Every stream pays a royalty to the artist.", pricing: "Free to listen • Royalty 0.004 € per stream (80/20 split)", capabilities: ["Artist uploads", "Playlists", "Charts", "Tips to artists", "Artist profiles", "Per-stream royalties"] },
