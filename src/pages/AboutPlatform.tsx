...
const ALL_CATEGORIES: Category[] = [
    ...
    ] },
  {
    ...
    sections: [
      ...
      { path: "/reel-battles", title: "Reel Battles", icon: Video, blurb: "Short-video duels decided by community votes.", features: ["Video duels", "Community voting", "Coin entry", "Winner payout", "Leaderboards", "Auto settlement"], details: "Upload a short clip, get matched against another creator and let the community vote. Entry costs coins; the duel settles automatically when it ends and the winner takes the pot plus XP.", pricing: "Entry 100 coins • Winner takes 160 coins + 10 XP", capabilities: ["Head-to-head video duels", "Community voting", "Automatic settlement", "Coin pot payout", "XP rewards", "Duel leaderboards"] },
