...
const ALL_CATEGORIES: Category[] = [
    ...
    ] },
  {
    ...
    sections: [
      ...
      { path: "/healthcare", title: "Healthcare & Doctors", icon: Activity, blurb: "Book online doctor consultations, manage records and e-prescriptions.", features: ["Doctor booking", "Video consultations", "E-prescriptions", "Medical records", "Insurance claims", "24h refund window"], details: "Browse verified doctors, book a slot and meet by video. Doctors can issue e-prescriptions and get time-boxed access to the records you share. Appointments cancelled within 24 hours are refunded automatically.", pricing: "Consultation price set by doctor • 85/15 split • 24h refund window", capabilities: ["Verified doctor directory", "Availability slots & booking", "Video consultations", "E-prescriptions", "Personal medical records with time-boxed doctor access", "Insurance claim export", "Booking history", "Automatic 24h refunds"] },
    ...
    ] },
  {
    ...
    sections: [
      ...
      { path: "/language-learning", title: "Language Learning", icon: Globe, blurb: "Learn languages with AI conversation partners and spaced repetition.", features: ["AI conversation", "Vocabulary SRS", "Pronunciation feedback", "Level tests", "Daily goals", "Multiple languages"], details: "Practice real conversations with an AI partner at your level, drill vocabulary with spaced repetition and get pronunciation feedback on what you say. Level tests place you and track progress.", pricing: "AI conversation 3 credits/session • Vocabulary drills free", capabilities: ["AI conversation partner", "Spaced-repetition vocabulary", "Pronunciation feedback", "Placement & level tests", "Daily goals & streaks", "Multiple target languages"] },
