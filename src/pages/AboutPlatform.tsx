...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { path: "/f1-racing", title: "GP Fantasy Racing", icon: Car, blurb: "Build cars, fantasy teams, races and subscriptions.", features: ["Car builder", "Fantasy teams", "Races", "Leaderboard", "Pit strategy", "Driver development"], details: "Build F1-style cars, manage two-driver teams, set pit strategy, race through a full calendar of Grand Prix events. Subscriptions unlock advanced telemetry and engineering tools.", pricing: "Free to play • Premium €9/mo for engineering tools", capabilities: ["Car builder with components", "Two-driver teams", "Pit strategy", "Full season calendar", "Driver development", "Premium telemetry", "Engineering tools", "Live leaderboards"] },
    ],
  },
  {
    id: "entertainment",
