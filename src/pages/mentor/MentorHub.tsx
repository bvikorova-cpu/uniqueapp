...
const FEATURES = [
  { to: "/ai-mentor/memory", icon: Brain, title: "Memory", desc: "Coach remembers across sessions" },
  { to: "/ai-mentor/skills", icon: Award, title: "Skills", desc: "20 named skills + progress" },
  { to: "/ai-mentor/personality", icon: UserCog, title: "Personality", desc: "Big Five assessment" },
  { to: "/ai-mentor/roleplay", icon: Theater, title: "Role-play", desc: "12 scenarios to practice" },
  { to: "/ai-mentor/feedback360", icon: Users, title: "360° Feedback", desc: "Anonymous peer review" },
  { to: "/ai-mentor/nudges", icon: Bell, title: "Daily Nudges", desc: "AI reminders" },
  { to: "/ai-mentor/goals", icon: Target, title: "SMART Goals", desc: "AI-generated milestones" },
  { to: "/ai-mentor/reflections", icon: Lightbulb, title: "Reflections", desc: "Prompts by mood" },
  { to: "/ai-mentor/habits", icon: Repeat, title: "Habits", desc: "Streaks + freeze tokens" },
  { to: "/ai-mentor/coach", icon: MessageCircle, title: "Coach Styles", desc: "4 personalities" },
  { to: "/ai-mentor/summaries", icon: ScrollText, title: "Summaries", desc: "Session insights" },
  { to: "/ai-mentor/voice-journal", icon: Mic2, title: "Voice Journal", desc: "Emotion detection" },
  { to: "/ai-mentor/cbt", icon: BookHeart, title: "CBT Programs", desc: "21-day rewires" },
