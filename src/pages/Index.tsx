  ...
  return (
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-6 sm:py-10 space-y-10 sm:space-y-14">
        ...
        {/* Everything below the fold is code-split into its own chunk and
            mounted only when the sentinel scrolls near the viewport. This
            removes framer spotlight, 20+ section preview videos, and all
            spotlight images from the initial mobile JS payload. */}
        <LazyOnVisible
          loader={() => import("./IndexBelowFold")}
          ecosystemModules={ecosystemModules}
