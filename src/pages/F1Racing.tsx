...
const F1Racing = () => {
  ...
  if (!isSubscribed) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-900 via-black to-gray-900 p-4 flex items-center justify-center">
        <Card className="max-w-2xl border-4 border-red-500 bg-black/80 text-white">
          <CardHeader>
