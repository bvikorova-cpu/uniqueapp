...
const Megatalent = () => {
  ...
  const fetchSubmissions = async () => {
    ...
    try {
      ...
      if (submissionsData && submissionsData.length > 0) {
        ...
        const { data: profilesData } = await (supabase as any).from('profiles').select('id, full_name, avatar_url').in('id', userIds);
  ...
  return (
    <>
      ...
      />
      <div className="min-h-screen bg-background pt-14 lg:pt-20 pb-12">
