...
const ContentStudio = () => {
  ...
  if (activeView === "brand-voice") return <div className="min-h-screen overflow-x-hidden bg-background pt-20 pb-80 sm:pb-20"><div className="container mx-auto max-w-7xl px-4"><BrandVoiceTraining onBack={() => setActiveView("main")} /></div></div>;
  ...
  if (activeView === "repurpose") return <div className="min-h-screen overflow-x-hidden bg-background pt-20 pb-56 sm:pb-20"><div className="container mx-auto max-w-7xl px-4"><ContentRepurposer onBack={() => setActiveView("main")} /></div></div>;
  ...
  if (activeView === "ab-test") return <div className="min-h-screen overflow-x-hidden bg-background pt-20 pb-56 sm:pb-20"><div className="container mx-auto max-w-7xl px-4"><ABABTesting onBack={() => setActiveView("main")} /></div></div>;
  if (activeView === "bulk") return <div className="min-h-screen overflow-x-hidden bg-background pt-20 pb-56 sm:pb-20"><div className="container mx-auto max-w-7xl px-4"><BulkContentGenerator onBack={() => setActiveView("main")} /></div></div>;
