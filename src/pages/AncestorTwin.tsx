...
const AncestorTwin = () => {
  ...
  const pricingTiers = [
    {
      ...
      name: 'Basic Match',
      price: '€1.99',
      priceId: 'price_1T0LXy0QTWhd4oRp4RjDX2Rj',
      icon: Users,
    ...
    },
    {
      ...
      name: 'Extended Match',
      price: '€6.99',
      priceId: 'price_1T0LXz0QTWhd4oRpIQfoiKVD',
      icon: Sparkles,
      popular: true,
    ...
    },
    {
      ...
      price: '€14.99',
      priceId: 'price_1T0LY10QTWhd4oRpmJsiwXo8',
      icon: Dna,
    ...
    },
    {
      ...
      price: '€49.99',
      priceId: 'price_1T0LY20QTWhd4oRpVrauvwWo',
      icon: ImageIcon,
  ...
  const subscriptionPlan = {
    ...
    price: '€7.99/month',
    priceId: 'price_1T0LY50QTWhd4oRpISGcAh76',
    icon: Crown,
