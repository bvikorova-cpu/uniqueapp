...
const SuperHeroUniverse = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Exclusive F1-Style Dark Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-black via-slate-950 to-zinc-950">
        {/* Subtle Carbon Fiber Pattern */}
        <div className="absolute inset-0 opacity-5 bg-[url('data:image/svg+xml;base64,')]"></div>
        
        {/* Racing Lines - Red Accent */}
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-1/4 left-0 w-96 h-96 bg-red-600 rounded-full mix-blend-screen filter blur-3xl"></div>
          <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-zinc-700 rounded-full mix-blend-screen filter blur-3xl"></div>
        </div>
      </div>
