    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-primary/[0.04] to-background pt-20 pb-12">
      <div className="container mx-auto px-4">
        ...
        <Dialog open={!!selectedInfluencer} onOpenChange={() => setSelectedInfluencer(null)}>
          <DialogContent className="w-[calc(100vw-1rem)] max-w-[calc(100vw-1rem)] sm:w-auto sm:max-w-4xl max-h-[92vh] sm:max-h-[85vh] overflow-y-auto overflow-x-hidden p-3 sm:p-6">
            {selectedInfluencer && (
              <>
