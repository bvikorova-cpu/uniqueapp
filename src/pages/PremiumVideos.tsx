          ...
          {tab === "how" && (
            <div className="iri-card rounded-3xl p-5 sm:p-7">
              ...
              <div className="space-y-1.5 text-sm text-foreground/75">
                ...
                <p>6. Every time someone unlocks your video, you receive 0.5 video credits (50% share) into your creator balance — that’s <strong>€0.25 per unlock</strong> in real money. You can spend earned credits on boosts, frames or unlocking other videos.</p>
                <p>7. Creator earnings are <strong>real money</strong>: each earned credit converts at <strong>€0.50</strong> (0.5 credit = €0.25 per unlock) and can be cashed out from the “My videos” panel to your Earnings balance (minimum €20, i.e. 80 unlocks), then paid out to your bank. Only credits <strong>earned from unlocks</strong> are withdrawable — credits you bought are not.</p>
