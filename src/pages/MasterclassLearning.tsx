...
export default function MasterclassLearning() {
  ...
  const masterclassTitle = masterclassId?.replace(/-/g, " ") || "";
  const topics = courseContent[masterclassTitle] || [];
  const progress = getProgress(masterclassId || "", "masterclass");
  const certificate = certificates.find(
    (cert) => cert.content_id === masterclassId && cert.content_type === "masterclass"
  );
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>{progress?.time_spent_minutes || 0} mins watched</span>
                </div>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Module Navigation */}
            <Card className="p-6">
              <h3 className="font-semibold mb-4">Masterclass Modules</h3>
