...
const AIExperiences = () => {
  ...
  const destinations = [
    ...
    { name: "Budapest", image: "https://images.unsplash.com/photo-1588953936179-a128f0e0f8c3?w=400&h=300&fit=crop", credits: 15 },
    ...
    { name: "Edinburgh", image: "https://images.unsplash.com/photo-1599953715484-9e409cd61e85?w=400&h=300&fit=crop", credits: 15 },
