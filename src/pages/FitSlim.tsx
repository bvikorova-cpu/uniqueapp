...
const FitSlim = () => {
  ...
  const weightLossVideos = [
    ...
    {
      id: 16,
      title: "Burpees - výbušný tréning",
      duration: "10 min",
      difficulty: "Náročná",
      calories: "190 kcal",
      thumbnail: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/qLBImHhCXSw?autoplay=1&rel=0",
    },
    {
      id: 17,
      title: "Kettlebell swing - kompletný workout",
      duration: "15 min",
      difficulty: "Náročná",
      calories: "210 kcal",
      thumbnail: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/E5vM8OiPLKs?autoplay=1&rel=0",
    },
    {
      id: 18,
      title: "Yoga flow pre chudnutie",
      duration: "25 min",
      difficulty: "Stredná",
      calories: "180 kcal",
      thumbnail: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/oBu-pQG6sTY?autoplay=1&rel=0",
    },
    {
      id: 19,
      ...
      calories: "400 kcal",
      thumbnail: "https://images.unsplash.com/photo-1538805060514-97d9cc17730c?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/fGJ-FuFLQMc?autoplay=1&rel=0",
    },
    {
      id: 20,
      title: "Shadow boxing - boxerský tréning",
      duration: "20 min",
      difficulty: "Stredná",
      calories: "260 kcal",
      thumbnail: "https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/VWvVeKd6qSw?autoplay=1&rel=0",
    },
    {
      id: 21,
      ...
      calories: "130 kcal",
      thumbnail: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/nmwgirgXLYM?autoplay=1&rel=0",
    },
    {
      id: 22,
      title: "Zumba fitness - tanečná party",
      duration: "40 min",
      difficulty: "Stredná",
      calories: "350 kcal",
      thumbnail: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/FvbDq79YAqM?autoplay=1&rel=0",
    },
    {
      id: 23,
      title: "Circuit training - kruhový tréning",
      duration: "28 min",
      difficulty: "Náročná",
      calories: "310 kcal",
      thumbnail: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/ML6YYGq_8ps?autoplay=1&rel=0",
    },
    {
      id: 24,
      title: "Aqua aerobik doma",
      duration: "30 min",
      difficulty: "Ľahká",
      calories: "200 kcal",
      thumbnail: "https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/hEu7qYXdOKg?autoplay=1&rel=0",
    },
    {
      id: 25,
      title: "Tréning s odporom - resistance bands",
      duration: "22 min",
      difficulty: "Stredná",
      calories: "195 kcal",
      thumbnail: "https://images.unsplash.com/photo-1549576490-b0b4831ef60a?w=800&auto=format&fit=crop",
      videoUrl: "https://www.youtube.com/embed/ek7CuJ6OlVI?autoplay=1&rel=0",
    },
  ];
  ...
  const weightLossRecipes = [
    ...
    {
      id: 19,
      title: "Buddha bowl s kúskami lososa",
      calories: "380 kcal",
      protein: "35g",
      time: "28 min",
      image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=800&auto=format&fit=crop",
    ...
    {
      id: 20,
      title: "Zeleninové chilli con carne",
      calories: "310 kcal",
      protein: "24g",
      time: "35 min",
      image: "https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=800&auto=format&fit=crop",
    ...
    {
      id: 21,
      title: "Pečené kuracie prsia s quinoou",
      calories: "345 kcal",
      protein: "40g",
      time: "30 min",
      image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&auto=format&fit=crop",
    ...
    {
      id: 22,
      title: "Špenátový quiche s nízkym obsahom uhľohydrátov",
      calories: "275 kcal",
      protein: "19g",
      time: "45 min",
      image: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=800&auto=format&fit=crop",
    ...
    {
      id: 23,
      title: "Grilovaná zelenina s feta syrom",
      calories: "230 kcal",
      protein: "12g",
      time: "25 min",
      image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=800&auto=format&fit=crop",
    ...
    {
      id: 24,
      title: "Morčacie klopsy v paradajkovej omáčke",
      calories: "295 kcal",
      protein: "31g",
      time: "35 min",
      image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&auto=format&fit=crop",
    ...
    {
      id: 25,
      title: "Kapustový šalát coleslaw s jogurtom",
      calories: "155 kcal",
      protein: "8g",
      time: "15 min",
      image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=800&auto=format&fit=crop",
    ...
    {
      id: 27,
      title: "Pečená paprika plnená mletým mäsom",
      calories: "265 kcal",
      protein: "26g",
      time: "40 min",
      image: "https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=800&auto=format&fit=crop",
    ...
    {
      id: 28,
      title: "Cuketa na spôsob špagiet (zoodles)",
      calories: "220 kcal",
      protein: "18g",
      time: "20 min",
      image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&auto=format&fit=crop",
