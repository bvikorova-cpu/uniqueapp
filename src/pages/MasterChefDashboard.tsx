            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
                ...
                <div className="text-right">
                  ...
                  <Button size="sm" className="mt-2" onClick={() => console.info("[Coming soon] Sign Up")}>
                    Sign Up
                  </Button>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
                ...
                <div className="text-right">
                  ...
                  <Button size="sm" variant="outline" className="mt-2" onClick={() => console.info("[Coming soon] Details")}>
                    Details
                  </Button>
                </div>
              </div>
