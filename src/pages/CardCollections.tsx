    ...
    <div className="min-h-screen bg-background">
      <section className="relative h-[45vh] sm:h-[60vh] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 pt-16">
          ...
          <p className="mt-2 text-sm sm:text-base text-white/85 max-w-xl">
            45 themed collections · {CARDS_PER_CATEGORY} cards each · 6,750 cards to hunt down
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto max-w-6xl px-2 sm:px-4 pt-6 pb-28 md:pb-8 space-y-6">
        ...
        <FloatingHowItWorks
          ...
          steps={[
            { title: "Pick a collection", desc: "Forty-five themed collections, each with 150 fixed cards — mythic beasts, duel stats, personality archetypes, memes, daily quests, lifehacks, world facts, seasonal series, racehorses and seven sports sets (football, basketball, ice hockey, tennis, American football, baseball, golf) plus beauty icons, fashion couture, royal princesses, storybook folk plus sixteen Kids Collectibles sets for younger collectors — ten hand-drawn cartoon sets and six cinematic 3D animated-movie sets." },
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground">
                45 collections · 150 cards each · 6,750 cards to hunt down
              </p>
            </div>
