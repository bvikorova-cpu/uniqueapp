...
import { Gem, Wrench, Camera, Swords, Trophy, Medal } from "lucide-react";
      ...
      <div className="container mx-auto px-3 sm:px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6">
          ...
          <div className="bg-card/60 backdrop-blur-md border border-purple-500/20 rounded-xl p-3 sm:p-4 text-center">
            ...
            <p className="text-lg font-black">0/8</p>
          </div>
        ...
        <Tabs defaultValue="tools" className="w-full">
          <TabsList className="grid w-full grid-cols-5 mb-6">
            <TabsTrigger value="tools" className="text-xs sm:text-sm"><Wrench className="h-3 w-3 sm:mr-1" /><span className="hidden sm:inline">Tools</span></TabsTrigger>
            <TabsTrigger value="streaks" className="text-xs sm:text-sm"><Camera className="h-3 w-3 sm:mr-1" /><span className="hidden sm:inline">Streaks</span></TabsTrigger>
            <TabsTrigger value="duels" className="text-xs sm:text-sm"><Swords className="h-3 w-3 sm:mr-1" /><span className="hidden sm:inline">Duels</span></TabsTrigger>
            <TabsTrigger value="leaderboard" className="text-xs sm:text-sm"><Trophy className="h-3 w-3 sm:mr-1" /><span className="hidden sm:inline">Ranks</span></TabsTrigger>
            <TabsTrigger value="achievements" className="text-xs sm:text-sm"><Medal className="h-3 w-3 sm:mr-1" /><span className="hidden sm:inline">Badges</span></TabsTrigger>
          </TabsList>
