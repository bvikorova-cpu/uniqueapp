    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate('/fundraising/dream')}>
            Back to Dream Maker
          </Button>
        </div>
      </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <Badge variant="secondary">{dreamTypeLabels[campaign.dream_type]}</Badge>
                </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      step="1"
                    />
                    <p className="text-sm text-muted-foreground mt-1">Minimum: €1</p>
                  </div>
