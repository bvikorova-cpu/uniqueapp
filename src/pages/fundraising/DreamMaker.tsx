...
import { DreamHero } from '@/components/fundraising/dream/DreamHero';
import { DreamStepsWizard } from '@/components/fundraising/dream/DreamStepsWizard';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading ? (
              ...
              filteredCampaigns.map((campaign) => (
                <DreamCampaignCard key={campaign.id} campaign={campaign} />
              ))
            )}
          </div>
        </div>
