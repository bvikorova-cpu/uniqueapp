...
export const ForSchools = lazy(() => import("@/pages/ForSchools"));
export const ForHealthcare = lazy(() => import("@/pages/ForHealthcare"));
export const ForBusiness = lazy(() => import("@/pages/ForBusiness"));
