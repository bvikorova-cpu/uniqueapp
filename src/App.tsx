...
const AdminBookPreorders = lazy(() => import("@/pages/admin/AdminBookPreorders"));
                    ...
                    <RouteResetErrorBoundary>
                      <Suspense fallback={<PageLoader />}>
                       ...
                       <Route path="/wall/memories" element={<ProtectedRoute><Wall /></ProtectedRoute>} />
                        ...
                        <Route path="/gifts/collection" element={<ProtectedRoute><GiftCollection /></ProtectedRoute>} />
                       ...
                       <Route path="/security-center" element={<ScamProtectionCenter />} />
                        ...
                        <Route path="/admin/book-preorders" element={<ProtectedRoute requireAdmin={true}><AdminBookPreorders /></ProtectedRoute>} />
