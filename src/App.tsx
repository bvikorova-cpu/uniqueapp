...
import DisneyCastle3D from "./pages/DisneyCastle3D";
...
import VoiceMemorial from "./pages/VoiceMemorial";
      ...
      <AuthProvider>
        <TooltipProvider delayDuration={0}>
          ...
          <Route path="/virtual-escape-room" element={<VirtualEscapeRoom />} />
              ...
              <Route path="/kids-channel/disney-castles/:castleId/3d" element={<DisneyCastle3D />} />
              ...
              <Route path="/voice-memorial-pricing" element={<VoiceMemorialPricing />} />
