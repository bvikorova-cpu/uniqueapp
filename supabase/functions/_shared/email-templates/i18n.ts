...
export const EMAIL_TRANSLATIONS: Record<EmailLang, AllStrings> = { en, sk, cs, de, es, fr, it, hu, ru, ja, ko, zh }
...
export const HTML_LANG_BY_CODE: Record<EmailLang, string> = { en: 'en', sk: 'sk', cs: 'cs', de: 'de', es: 'es', fr: 'fr', it: 'it',
