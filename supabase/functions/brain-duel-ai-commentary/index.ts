...
serve(async (req) => {
  ...
  try {
    ...
    const stylePrompts: Record<string, string> = { sports: "You are an enthusiastic sports commentator narrating an epic brain duel match. Use dramatic language, play-by-play style, crowd reactions, and build tension throughout.",
