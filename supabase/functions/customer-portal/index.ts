// Universal Stripe customer portal. Accepts optional { return_path } and { module }.
// All legacy *-customer-portal functions proxy to this one.
...
serve(async (req) => {
  ...
  try {
    ...
    const returnPath: string = body?.return_path || "/billing";
