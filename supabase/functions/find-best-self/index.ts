...
const SYSTEM = `Explore the user's best possible self in alternate timelines. Return JSON: {best_self_description, key_traits[], life_path, achievements[], wisdom_message}.`;
