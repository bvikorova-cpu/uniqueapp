...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  uniquemascot: "a fun photo of the person standing next to a friendly plush mascot character shaped like the official Unique app logo: a glossy rounded-square icon with a smooth gradient from violet-purple (left) to hot pink (right), a large white calligraphic script letter "U" centred on it and a bright four-point white sparkle star at the top right of the U. Directly UNDER the logo render the exact clean sans-serif text "www.uniqueapp.fun" — spelled exactly that way, sharp and perfectly legible — a cute rounded purple-pink mascot with the white script U and sparkle, and the site text on its badge. Cheerful bright scene, both facing camera",
