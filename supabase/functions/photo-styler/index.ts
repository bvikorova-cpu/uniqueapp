...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  uniquemascot: "a fun photo of the person standing next to a friendly soft mascot shaped exactly like the Unique logo — a rounded purple-pink plush form with the white script 'U' and sparkle on the front, NO eyes, NO mouth, NO facial features. Directly under the mascot render the official Unique app logo: a glossy rounded-square icon with a smooth gradient from violet-purple (left) to hot pink (right), a large white calligraphic script letter 'U' centred on it and a bright four-point white sparkle star at the top right of the U, and the exact clean sans-serif text 'www.uniqueapp.fun' — spelled exactly that way, sharp and perfectly legible. Cheerful bright scene, both facing camera",
