  ...
  try {
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        model: "gpt-4o-mini",
        messages: [
          { role: "system", content: "You are an expert antique appraiser. Provide a quick but comprehensive identification including: item name, estimated period, style, materials, origin, estimated value range in EUR, and condition assessment. Format with clear markdown headers." },
          { role: "user", content: [
            { type: "text", text: "Identify and appraise this antique item:" },
