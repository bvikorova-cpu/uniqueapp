...
DECLARE
  ...
  cities TEXT[] := ARRAY['City, Country','Kosice, Country','Zilina, Country','City, Country','City, Country','City, Country','Prague, Czechia','Brno, Czechia','Vienna, Austria','Graz, Austria','Budapest, Hungary','Warsaw, Poland','Krakow, Poland','Global','Munich, Germany','Amsterdam, Netherlands','Barcelona, Spain','Madrid, Spain','Rome, Italy','Milan, Italy','Paris, France','Lyon, France','Lisbon, Portugal','Copenhagen, Denmark','Stockholm, Sweden','Oslo, Norway','Helsinki, Finland','Dublin, Ireland','London, UK','Edinburgh, UK','Athens, Greece','Zagreb, Croatia','Ljubljana, Slovenia','Bucharest, Romania','Sofia, Bulgaria','Zurich, Switzerland'];
