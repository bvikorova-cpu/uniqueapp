...
BEGIN
  ...
  SELECT c.creator_id, c.title INTO v_creator, v_title FROM public.courses c WHERE c.id = p_course_id;
...
REVOKE EXECUTE ON FUNCTION public.request_course_access(uuid) FROM anon, public;
