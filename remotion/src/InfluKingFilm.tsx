...
const BEATS: Beat[] = [
  {
    badge: "Step 1 · Create",
    title: "Show up. Post.",
    subtitle: "Reels, photos, stories, lives — every drop counts toward your score.",
    perks: ["Any format", "Daily bonus streaks", "AI content assist"],
    image: "influking/01-creator.jpg",
    accent: "#ec4899",
    accent2: "#a855f7",
  },
  {
    badge: "Step 2 · Go viral",
    title: "Watch it explode.",
    subtitle: "Likes, comments, shares and watch-time compound into real reach points.",
    perks: ["Weighted engagement", "Anti-bot filter", "Real-time score"],
  ...
  },
  {
    ...
    subtitle: "Global, country and category leaderboards refresh live — every hour matters.",
    perks: ["Global & country boards", "By-category ranks", "Live position tracker"],
  ...
  },
  {
    ...
    subtitle: "Monthly winner gets the golden Influ-King badge — and the spotlight.",
    perks: ["Golden crown badge", "Featured on Home", "Hall of Fame"],
    image: "influking/03-crown.jpg",
    accent: "#fbbf24",
    accent2: "#ec4899",
  },
  {
    badge: "Step 5 · Cash in",
    title: "Get paid in EUR.",
    subtitle: "Brand deals, tips and creator payouts hit your wallet directly.",
    perks: ["Brand deal matches", "Fan tips", "Direct EUR payout"],
