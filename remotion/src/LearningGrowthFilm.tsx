  ...
  return (
    <AbsoluteFill>
      <AbsoluteFill style={{ transform: `scale(${kb})` }}>
        <Img src={staticFile("learninggrowth/02-iq.jpg")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
      ...
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", flexDirection: "column", opacity: 1 - exit }}>
        ...
        <div
          style={{
            ...
            fontSize: 260,
            lineHeight: 1,
            background: `linear-gradient(180deg, ${BRAND.white} 0%, #c4b5fd 100%)`,
...
export const LEARNINGGROWTH_DURATION = INTRO + BEATS.length * BEAT_DUR + OUTRO;

export const LearningGrowthFilm: React.FC = () => {
  const frame = useCurrentFrame();
  const total = LEARNINGGROWTH_DURATION;
