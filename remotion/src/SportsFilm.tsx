  ...
  return (
    <AbsoluteFill>
      <AbsoluteFill style={{ transform: `scale(${kb})` }}>
        <Img
          src={staticFile("sports/04-basketball.jpg")}
                ...
                >
                  ...
                  >
                    <svg viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="white" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <path d="M18 9h1.5A2.5 2.5 0 0 0 22 6.5V5a1 1 0 0 0-1-1h-3" />
...
export const SPORTS_DURATION = INTRO + PROMISE + MODULES.length * MODULE_DUR + OUTRO;

export const SportsFilm: React.FC = () => {
  const frame = useCurrentFrame();
  const total = SPORTS_DURATION;
