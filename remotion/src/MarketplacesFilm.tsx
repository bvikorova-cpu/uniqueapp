  ...
  return (
    <AbsoluteFill>
      <AbsoluteFill style={{ transform: `scale(${kb})` }}>
        <Img src={staticFile("marketplaces/04-bazaar.jpg")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
...
export const MARKETPLACES_DURATION = INTRO + BEATS.length * BEAT_DUR + OUTRO;

export const MarketplacesFilm: React.FC = () => {
  const frame = useCurrentFrame();
  const total = MARKETPLACES_DURATION;
